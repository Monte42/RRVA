    ...
    <div class="content">
      <div class="form">
        ...
        <div style="text-align: left;" class="container">
          <p>
            As provided by our Declarations, in the event you make your home available
            for use by guests while you are not present, you are required to inform
            the Association of such use. This means that if you make your home available
            without charge to friends or family members who do not reside with you in
            your principal home, you must provide the following information at least two
            business days before your Unit is occupied by a guest(s) or family members.
            <br><br>
            It is your obligation to make sure that your guests abide by the RRVA Rules
            and Regulations, plus the Common Ground rules, pool and tennis Court Rules,
            etc. that each resident has a copy of and are available on our website.
            Please note that any and all exterior damages and/or infraction of
            Association rules by your guest will be the ultimate responsibility of the
            homeowner. These rules include but are not limited to:
          </p>
          <br>
          <ul>
            <li>
              No motorcycles, 4 wheelers, trailers, etc. are allowed on RRVA property;
            </li>
            <li>
               No commercial vehicles are permitted on RRVA property between the hours
               of 9:00 PM and 7:00 AM;
            </li>
            <li>
              Dogs must be on leashes and picked up after;
            </li>
          </ul>
          <p>
            Our Declarations specifically provide that no Unit may “be used in any way
            or for any purpose which may endanger the health or unreasonably disturb the
            Owner of any Townhouse Unit or any resident thereof.
          </p>
        </div>
        <br>

        <form style="text-align: left;" class="container" action="guestInfoBack.php" method="POST">
          <span>
          ...
          <span>
            <label for="">Homeowners principal contact number:</label>
          </span>
          <span>
            <label for="mobile-phone">Mobile-</label>
            <input type="number" min="10" name="home-phone" required>
          </span>
          <span>
            <label for="home-phone">Home-</label>
            <input type="number" min='10' name="mobile-phone" required>
          </span>
          <br>
          <h6>If you only have one number Please Enter in both</h6><br>
          ...
          <span>
            <label for="">Guest contact number:</label>
          </span>
          <span>
            <label for="guest-mobile-phone">Mobile-</label>
            <input type="number" min="10" name="guest-mobile-phone" required>
          </span>
          <span>
            <label for="guest-home-phone">Home-</label>
            <input type="number" min='10' name="guest-home-phone" required>
          </span>
          <br>
          <h6>If you only have one number Please Enter in both</h6><br>

          <span>
            <label for="occupants">Number of Person Occupying Unit:</label>
            <input type="number" name="occupants" required>
          </span>

          <span>
            <label for="plate-numbers">License Plate Number(s):</label>
          ...
          <span>
            <label for="rent-start">Period of Use: From-</label>
            <input type="date" min='10' name="rent-start" required>
            <label for="rent-end">To-</label>
            <input type="date" min="10" name="rent-end" required>
          </span>

          <div style="text-align: left;" class="container">
            <p>
              As you are aware, each townhouse is issued 8 passes only for the
              recreational facilities. This means that only eight people from your
              townhouse may use the facilities at one time. This is to prevent
              over-crowding at the pool and the fair usage of chairs and lounges for
              all of our residents.
            </p>
            <br>
            <p>
              <strong>
                Please advise your guests that they must contact you with any problems
                or questions they may have while visiting.<br>
              </strong>
            </p>
          </div>
