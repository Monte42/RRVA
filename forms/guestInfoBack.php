...
function sendEmail($ppdf,$pname)
{
  ...
  try {
    ...
    $mail->addAddress('rrvainc@gmail.com', 'Ms. Neif');     // Add a recipient
      ...
      // Attachments
      $mail->addStringAttachment($ppdf, $pname.' Guest.pdf');


      // Content
      $mail->isHTML(true);                                  // Set email format to HTML
      $mail->Subject = 'Guest Coming For '.$pname;
      $mail->Body    = 'Hi Wendy my name is '.$pname.', and I would like to let
      you know That I will have some guests staying in my unit.';

      $mail->AltBody = 'Hi Wendy my name is '.$pname.', and I would like to let
      you know That I will have some guests staying in my unit.';
